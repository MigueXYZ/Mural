...
<div class="h-screen w-screen bg-[#07090d] text-zinc-100 overflow-hidden font-sans select-none flex flex-col">
  ...
  {:else}
    ...
    <header class="h-12 bg-zinc-950/95 border-b border-zinc-800/90 px-4 flex items-center justify-between z-20 flex-shrink-0 backdrop-blur-md">
      ...
      <!-- Center: Player Character HUD -->
      <div class="flex items-center gap-2 bg-zinc-900/80 border border-zinc-800 px-3 py-1 rounded-xl">
        <div
          class="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold text-zinc-950"
          style="background-color: {playerColorInput}"
        >
